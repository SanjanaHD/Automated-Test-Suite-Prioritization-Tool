...
//	final File  f = new File(MyClass.class.getProtectionDomain().getCodeSource().getLocation().getPath());
	...
	{
		count++;
//		System.out.println(s+" exists?="+testCount.containsKey(s));
...
//    	String[] ar={"org.apache.commons.dbutils.wrappers.SqlNullCheckedResultSetTest","org.apache.commons.dbutils.QueryRunnerTest","org.apache.commons.dbutils.wrappers.SqlNullCheckedResultSetTest"};
